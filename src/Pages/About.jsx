      ...
      <div className="h-3/4 w-[90%] z-30 mt-20 mx-auto flex lg:flex-row flex-col lg:gap-10 justify-center items-center">
          <div style={{ boxShadow:"0px 4px 24px #1d2fb5"}} className="hidden lg:flex items-center justify-center flex-col h-full w-[60%] gap-8 ">
            ...
            <div style={{ boxShadow:"0px 4px 24px #1d2fb5"}} className="h-1/2 w-[90%] rounded-2xl bg-black/40 backdrop-blur-lg flex justify-center flex-col px-10 py-6 border-2 border-blue-600 transition-all duration-300 ease-in-out hover:-translate-y-2 hover:scale-102">
              <h1 className="text-center text-white font-extrabold text-3xl">MY <span className="text-blue-600">EDUCATION</span></h1>
              <h1 className="mt-10 text-gray-200 text-start font-bold text-lg">Bachelor of Technology in <span className="text-blue-600">Computer Science</span> and <span className="text-blue-600">Engineering</span> (2024 – 2028)</h1>
              <h2 className="text-gray-300 text-start font-semibold text-md">Veer Surendra Sai University of Technology (VSSUT),Burla</h2>
              <ul style={{ boxShadow:"0px 4px 24px #1d2fb5"}} className="list-disc text-gray-400 text-sm m-auto ml-7 bg-radial from-gray-900 to-black py-2 px-8 rounded-xl transition-all duration-300 border-2 border-transparent ease-in-out hover:translate-x-1.5 hover:-translate-y-1 hover:scale-101 hover:border-blue-900">
                <li><span className="text-blue-500">Academics </span>: Maintained a 9.26 CGPA across core DSA and DBMS subjects.</li>
                <li><span className="text-blue-500">Projects </span>: Collaborated in teams to build and optimize full-stack applications.</li>
              </ul>
            </div>
            <div className="h-1/3 w-[90%] flex gap-5">
              ...
              <div id="my-home" style={{ boxShadow:"0px 4px 24px #1d2fb5"}} className="relative h-full w-1/2 rounded-2xl bg-black/40 backdrop-blur-lg border-2 border-blue-600 overflow-hidden">
                <iframe
