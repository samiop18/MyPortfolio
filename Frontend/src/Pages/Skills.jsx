      ...
      <div className="z-30 h-[90%] w-[95%] flex lg:flex-row flex-col justify-center items-center lg:gap-7 gap-4 m-auto lg:mt-20 mt-5">
        ...
        <div className="lg:h-[80%] lg:w-[45%] h-1/2 w-full rounded-2xl flex flex-col items-center justify-center gap-5">
          ...
          <DivsBG />
              ...
              <div className="z-30 h-8/10 w-full flex-row flex items-center justify-center ">
                <Chart />
                <div className="z-30 h-full w-1/2 flex flex-col justify-center lg:gap-2 items-start">
                  <h1 className="lg:text-xl text-md flex items-center gap-1 text-gray-300 font-bold w-full">Leetcode <span className="text-pink-500"> Progress</span><a href='https://leetcode.com/u/iemcGXqwvo/' className="mt-0.5 ml-2 transition-all duration-200 ease-in-out hover:text-pink-500 active:scale-75"><ArrowUpRight strokeWidth={4}/></a></h1>
                  <ul>
                    ...
                    <li className="w-full flex flex-row justify-start gap-3  text-gray-300 font-light text-start items-center lg:text-sm text-xs">MAX STREAK <span className="text-pink-400 font-semibold">: {LeetcodeProgress.maxStreak} days</span></li>
                    <li className="w-full flex flex-row justify-start gap-3  text-gray-300 font-light text-start items-center lg:text-sm text-xs">Acceptance Rate <span className="text-pink-400 font-semibold">: 75.68%</span></li>
